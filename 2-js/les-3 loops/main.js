...
// let i = 1;
// while (i <= 20) {
//     document.write(`<div><h1>Aloha</h1></div>`);
//     i++;
// }
...
// let i = 0;
// while (i <= 19) {
//     document.write(`<div><h1>hola - ${i} </h1></div>`);
//     i++;
// }
...
//     <img style="width: 200px" src="${product.image}" alt="product-image" class="product-image">
// </div>`);
// }

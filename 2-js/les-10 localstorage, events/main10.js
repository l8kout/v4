// 1 - Стоврити форму з трьома полями для name,surname,age та кнопкою. При натисканні на кнопку зчитати данні з полів,
...
//     p.innerText = `${f1.name.value} ${f1.surname.value} ${f1.age.value}`;
//
//     div.appendChild(p);
//     document.body.appendChild(div);
// };

// 2 - є сторінка, на якій є блок, я кому знаходиьтся цифра. написати код, який при кожному перезавантажені сторінки
// буде додавати до неї +1
//
// let localNum = localStorage.getItem('number') || 0;
// let nam = document.getElementById('one');
// let newNum = (+localNum + 1).toString()
// nam.innerText = newNum;
// localStorage.setItem('number', newNum);
//
// let bloc = document.getElementById('one');
// console.log(typeof bloc.innerText)
//
// window.onload = function () {
//     // let num = JSON.parse(localStorage.getItem('num'));
//     localStorage.setItem('number',  document.getElementById('one').innerText);
//     let blocNum = parseInt(document.getElementById('one').innerText);
//     let localNum = parseInt(localStorage.getItem('number'));
//     if (blocNum === localNum) {
//         bloc.innerText++;
//         localStorage.setItem('number', bloc.innerText)
//     }
// };
//
// // let bloc2 = document.getElementById('one');
// //
// // window.onload = function () {
// //     console.log(bloc2.innerText)
// //     bloc2.innerText++
// // };

// ==========================
// 3.1 - Є сторінка index.html (назва довільна), при відвідуванні якої в локальне сховще, в масив sessions зберігається
// інформація про дату та час відвідування сторінки.
//
// window.onload = function () {
//     let date = new Date();
//     let time = date.getHours() + ':' + date.getMinutes() + ':' + date.getSeconds();
//     let sessionsArray = JSON.parse(localStorage.getItem('time')) || [];
//     sessionsArray.push(time);
//     localStorage.setItem('time', JSON.stringify(sessionsArray))
// };

// 3.2 - Є ще сторінка sessions.html (назва довільна), при відвідуванні якої потрібно відмалювати всю інформацію про
// відвідування сторінки index.html. Інфу НЕ виводити в консоль, а побудувати
// дом структуру під кожну сессію
//
//====== це завдання в папці task-3-session
...
prev.addEventListener('click',() => hendler(page -= 1));
next.addEventListener('click', () => hendler(page += 1));
hendler(page);

function hendler(page, limit = 10) {
    let newArr = [];
